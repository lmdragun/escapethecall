...
GameView.prototype = {
	...
	restartGame: function(){
		$("#start").append("<button class=\"restart\">Play Again?</button>");
	...
	win: function(){
		...
		$("#current-detail").append("<p class=\"winner\">You got off the phone with your mom!</p>");
		$(".winner").css("color", "green").css("font-size", "40px").css("font-family", "vtc_screamitloud").css("text-shadow", "5px 5px 5px #FFF").css("background-color", "rgba(0,0,0,.5)");
